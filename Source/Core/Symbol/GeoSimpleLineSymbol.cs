...
{
    public class GeoSimpleLineSymbol : GeoSymbol
    {
        #region 字段

        private string _Label = "";     //符号标签
        private bool _Visible = true;   //是否可见
        private GeoSimpleLineSymbolStyleConstant _Style = GeoSimpleLineSymbolStyleConstant.Solid; //形状
        ...
        public GeoSimpleLineSymbol()
        {
            CreateRandomColor();        //生成随机颜色
        }

        public GeoSimpleLineSymbol(string label)
        {
            _Label = label;
            CreateRandomColor();        //生成随机颜色
        }
        ...
        {
            get { return GeoSymbolTypeConstant.SimpleLineSymbol; }
        }
        ...
        /// 获取或设置形状
        /// </summary>
        public GeoSimpleLineSymbolStyleConstant Style
        {
            get { return _Style; }
            set { _Style = value; }
        }
