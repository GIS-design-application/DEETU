...
namespace DEETU.Map
{
    ...
    internal class GeoShapeFlashControler
    {
        #region 字段

        private GeoShape[] mShapes;      //图形集合
        ...
        internal GeoShapeFlashControler()
        {
        ...
        internal void StartFlash(GeoShape[] shapes, Int32 times, Int32 interval)
        {
            if (shapes.Length == 0)
                return;
            if (times <= 0)
        ...
        //需要绘制正在闪烁的图形
        internal delegate void NeedDrawFlashShapesHandle(object sender, GeoShape[] shapes);
